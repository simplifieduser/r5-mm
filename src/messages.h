...
#define NO_FILE_INPUT ILLEGAL_ARGUMENT_PASSING "You are required to forward a filename as the positional argument"
...
#define ILLEGAL_ARGUMENT_TREACE_FILE ILLEGAL_ARGUMENT_PASSING "'Tracefile(-f/--tf==)' has to be a filename. '--tf' is invalid use either '-f' or '--tf='"
